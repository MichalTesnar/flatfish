...
#include <ros2_driver_base/fixture_boost_test.hpp>
...
struct Fixture : ros2_driver_base::Fixture<Driver>
{
    Fixture()
    {
        driver.openURI("test://");
...
struct FixtureNoOpen : ros2_driver_base::Fixture<Driver>
{
};
...
struct DriverClassNameTestFixture : ros2_driver_base::Fixture<DriverClassNameDriver>
{
};
...
struct openURIMockTestFixture : ros2_driver_base::Fixture<openURIMockTestDriver>
{
};
