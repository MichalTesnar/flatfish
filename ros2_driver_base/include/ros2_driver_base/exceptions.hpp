#ifndef ROS2_DRIVER_BASE_EXCEPTIONS_HPP
#define ROS2_DRIVER_BASE_EXCEPTIONS_HPP
...
class MockContextException : public std::exception
{
    public:
        ...
        {
            return "ROS2_DRIVER_BASE_MOCK Error: Expectation set outside Mock Context! Please call ROS2_DRIVER_BASE_MOCK() before setting expectations";
        }
};
...
class TestEndsWithExpectationsLeftException : public std::exception
{
       public:
        const char * what() const throw()
        {
            return "ROS2_DRIVER_BASE_MOCK Error: Test reached its end without satisfying all expecations";
        }
};
