#ifndef ROS2_DRIVER_BASE_HPP
#define ROS2_DRIVER_BASE_HPP
...
{
    /** A IOStream meant to be used to test ros2_driver_base functionality
     * from outside
     *
    ...
    public:
         ...
         * mock mode. Should be used after setting up ROS2_DRIVER_BASE_MOCK().
        ...
        void waitRead(std::chrono::milliseconds const& timeout);
        void waitWrite(std::chrono::milliseconds const& timeout);
