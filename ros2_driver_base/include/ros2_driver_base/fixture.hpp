#ifndef ROS2_DRIVER_BASE_BOOST_FIXTURE_HPP
#define ROS2_DRIVER_BASE_BOOST_FIXTURE_HPP
...
{
    /** A fixture class designed to ease testing of ros2_driver_base drivers in
     * boost and GTest
     *
     ...
     *
     * <code>
     * struct DriverTest : ::testing::Test, ros2_driver_base::Fixture<MyDriver>
     * {
     *    Fixture()
     *    {
     *       // Optional: open here
     ...
     * is expected, the mock mode should be set, using ROS2_DRIVER_BASE_MOCK().
