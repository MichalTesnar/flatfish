...
struct DriverTest : ::testing::Test, ros2_driver_base::Fixture<DriverEasySYNC>
{
    DriverTest()
    {
    }
    ...
    void EXPECT_REPLY(const char* cmd, const char* reply)
    {
        ...
        ros2_driver_base::Fixture<DriverEasySYNC>::EXPECT_REPLY(
    ...
    void pushDataToDriver(char const* msg)
    {
        ...
        ros2_driver_base::Fixture<DriverEasySYNC>::pushDataToDriver(packet);
    }
};
