...
#include <math.h>
#include <stdint.h>
#include <thruster_enitech/Status.hpp>
#include <thruster_enitech/Emergency.hpp>
...
namespace thruster_enitech
{
    ...
    public: 
         ...
         */
        canbus::Message makeCommand(const double value) const;
    ...
    private:
        uint8_t mNodeID;
        std::chrono::system_clock::time_point mLastHeartBeat; // default UNIX in nanoseconds (uint64) 
