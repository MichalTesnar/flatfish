...
#include <thruster_enitech/Request.hpp>
#include <stdexcept> 
#include <string>
...
namespace thruster_enitech {
    ...
    namespace SDO {
        ...
        {
            WriteHeartbeatPeriod(Protocol& protocol, std::chrono::milliseconds const& period);
        };
        ...
        {
            WriteUpdatePeriod(Protocol& protocol, std::chrono::milliseconds const& period);
        };
    }
}
